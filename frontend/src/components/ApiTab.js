    ...
    return (
      <div className="card" style={{ textAlign: 'center', padding: '48px 24px' }}>
        ...
        <p style={{ color: 'var(--gray-600)', maxWidth: '400px', margin: '0 auto 24px' }}>
          Integrate ReviewResponder into your own applications with our REST API. Available
          exclusively for Unlimited plan subscribers.
        </p>
        <div
          style={{
        ...
        >
          ...
          >
            <li style={{ marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <CheckCircle size={16} style={{ color: 'var(--success-500)' }} /> Up to 5 API keys
            </li>
            <li style={{ marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <CheckCircle size={16} style={{ color: 'var(--success-500)' }} /> 100 requests per day
              per key
            </li>
            <li style={{ marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <CheckCircle size={16} style={{ color: 'var(--success-500)' }} /> Full API
              documentation
            </li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <CheckCircle size={16} style={{ color: 'var(--success-500)' }} /> cURL, JavaScript,
              Python examples
            </li>
          </ul>
        </div>
    ...
    <div style={{ display: 'grid', gap: '24px' }}>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: '14px', color: 'var(--gray-600)', marginBottom: '20px' }}>
          Use API keys to integrate ReviewResponder into your applications. Each key has a limit of
              ...
              >
                ...
                >
                  <div style={{ flex: '1', minWidth: '200px' }}>
                    {editingKeyId === key.id ? (
                      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                        ...
                        <button
                          className="btn btn-primary"
                          onClick={() => updateApiKey(key.id, { name: editingKeyName })}
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <button
                        onClick={() => updateApiKey(key.id, { isActive: !key.is_active })}
                        style={{
                          background: key.is_active ? 'var(--success-100)' : 'var(--gray-200)',
                          color: key.is_active ? 'var(--success-700)' : 'var(--gray-600)',
                          border: 'none',
                          padding: '6px 12px',
                          borderRadius: '6px',
                          fontSize: '13px',
      ...
      <div className="card">
        ...
        >
          {['quickstart', 'reference', 'errors'].map(section => (
            <button
              key={section}
              onClick={() => setApiDocSection(section)}
              style={{
                padding: '10px 16px',
                background: apiDocSection === section ? 'var(--primary-50)' : 'transparent',
                border: 'none',
                borderBottom:
                  apiDocSection === section
                    ? '2px solid var(--primary-600)'
                    : '2px solid transparent',
                color: apiDocSection === section ? 'var(--primary-600)' : 'var(--gray-600)',
                fontWeight: apiDocSection === section ? '600' : '500',
                cursor: 'pointer',
                fontSize: '14px',
                marginBottom: '-1px',
              }}
        ...
        {apiDocSection === 'quickstart' && (
          <div>
            ...
            <p style={{ fontSize: '14px', color: 'var(--gray-600)', marginBottom: '16px' }}>
              Generate AI-powered review responses with a single API call. Include your API key in
  ...
  "language": "en"
          ...
          <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
              ...
              <tbody>
                <tr>
                  <td style={{ padding: '10px 12px', borderBottom: '1px solid var(--gray-100)' }}>
                    <code style={{ color: 'var(--error-600)' }}>400</code>
                  </td>
                  <td
                    style={{
                      padding: '10px 12px',
                  ...
                  >
                    Missing review_text in request body
                  </td>
                </tr>
                <tr>
                  <td style={{ padding: '10px 12px', borderBottom: '1px solid var(--gray-100)' }}>
                    <code style={{ color: 'var(--error-600)' }}>401</code>
                  </td>
                  <td
                    style={{
                      padding: '10px 12px',
                ...
                <tr>
                  <td style={{ padding: '10px 12px', borderBottom: '1px solid var(--gray-100)' }}>
                    <code style={{ color: 'var(--error-600)' }}>403</code>
                  </td>
                  <td
                    style={{
                      padding: '10px 12px',
                  ...
                  >
                    Unlimited plan required for API access
                  </td>
                </tr>
                <tr>
                  <td style={{ padding: '10px 12px', borderBottom: '1px solid var(--gray-100)' }}>
                    <code style={{ color: 'var(--error-600)' }}>429</code>
                  </td>
                  <td
                    style={{
                      padding: '10px 12px',
                ...
                <tr>
                  <td style={{ padding: '10px 12px', borderBottom: '1px solid var(--gray-100)' }}>
                    <code style={{ color: 'var(--error-600)' }}>500</code>
                  </td>
                  <td
                    style={{
                      padding: '10px 12px',
      ...
      {showCreateKeyModal && (
        <div
          ...
          onClick={() => !newlyCreatedKey && setShowCreateKeyModal(false)}
        >
          <div
            className="card"
              ...
              <>
                ...
                >
                  ...
                  <p style={{ fontSize: '13px', color: 'var(--warning-800)', margin: 0 }}>
                    <strong>Important:</strong> This is the only time you'll see this key. Copy it
