...
powershell -File scripts/agent-helpers.ps1 -Action track-outcome -Agent 1 `
...
```powershell
powershell -File scripts/agent-helpers.ps1 -Action check-outcomes -Agent 1
```

### 3. Derive Learnings (bei 10+ Aktionen)
```powershell
powershell -File scripts/agent-helpers.ps1 -Action derive-learning -Agent 1
```
