...
powershell -File scripts/agent-helpers.ps1 -Action track-outcome -Agent 10 `
...
```powershell
powershell -File scripts/agent-helpers.ps1 -Action check-outcomes -Agent 10
```

### 3. Derive Learnings (bei 10+ Aktionen)
```powershell
powershell -File scripts/agent-helpers.ps1 -Action derive-learning -Agent 10
```
