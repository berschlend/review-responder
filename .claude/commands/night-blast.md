...
Nur für `/night-blast --quick` - Schneller Durchlauf ohne autonomen Loop:
1. Server Night Blast triggern
2. Omnichannel DMs senden
3. Fertig

Für den Quick Mode siehe `/omnichannel-blast`.

---

# STANDARD: Autonomer Nacht-Modus
...
### Phase 3.5: OMNICHANNEL DMs (JEDE STUNDE!)

**WICHTIG:** Mindestens 1x pro Stunde Social Media DMs senden!

```bash
# 1. Leads mit Social Links holen
curl -s "https://review-responder.onrender.com/api/admin/leads-for-omnichannel?key=rr_admin_7x9Kp2mNqL5wYzR8vTbE3hJcXfGdAs4U"
```

Für jeden Lead mit Social Links (max 30 Twitter, 20 FB, 20 Instagram pro Tag):
...
**Message Template (DE für DE/AT/CH Städte):**
```
Hey! 👋
...
**Message Template (EN für alle anderen):**
```
Hey! 👋
...
**Rate Limits - BEI WARNUNG/CAPTCHA SOFORT STOPPEN!**
| Platform | Max/Tag |
|----------|---------|
| Twitter | 30 |
| Facebook | 20 |
...
Emails: +Y
Demos: +Z
DMs: Twitter +X, Facebook +Y, Instagram +Z
...
6. **Omnichannel DMs senden** (siehe Phase 3.5 oben!)
7. Dokumentieren
8. **HOURLY:** Tab Status checken, Stale Sessions cleanen
9. Repeat

**WICHTIG:** Schritt 6 (DMs) mindestens 1x pro Stunde machen!
