# LinkedIn Outreach Messages for ReviewResponder

> **Goal:** 100 potential customers contacted per week
> **Product:** AI-powered review response generator for businesses
...
Quick question - do you currently respond to all your Google/Yelp reviews?

Most businesses I talk to either:
A) Spend 30+ min/day on reviews
B) Skip responding entirely (hurting their reputation)

We built ReviewResponder to solve this - AI generates perfect responses in seconds.

Would a 2-min demo be helpful? Here's a quick example:
[DEMO LINK: https://review-responder-frontend.onrender.com]

No pressure - just thought it might save you time!
```
...
A {industry} business we work with was spending 5+ hours/week on review responses. Now they do it in under 30 minutes - and their response rate went from 40% to 100%.

The secret? AI-generated responses that sound human and match their brand voice.

Curious if this could help {company}? Happy to show you how it works!
```
...
Thought you'd want to know - we're offering 5 FREE review responses to new users. No credit card needed.

Just:
1. Paste any review
2. Pick a tone (Professional/Friendly/Apologetic)
3. Get a perfect response in seconds

Try it: https://review-responder-frontend.onrender.com

Would love your feedback if you give it a spin!
```
...
88% of consumers read reviews before buying. But here's the kicker - they also read HOW businesses respond.

A thoughtful response to a negative review can actually turn it into a positive impression.

The challenge? Writing good responses takes time and skill.

That's why we built ReviewResponder - AI does the heavy lifting, you just approve.

Want to see it in action? Takes 60 seconds.
```
...
Quick heads up - we're running a 50% launch discount (code: EARLY50) for the first 50 customers.

If review management is on your radar, now's a good time to check it out:
https://review-responder-frontend.onrender.com

The discount applies to all plans and lasts forever - no catch.
...
1. Paste any customer review
2. Choose your tone (Professional, Friendly, Formal, Apologetic)
3. AI generates a perfect response in 3 seconds
4. Copy, edit if needed, post!

Works with Google, Yelp, TripAdvisor, Facebook - any platform.

Want to try it? Here's a free trial: https://review-responder-frontend.onrender.com

Or I can do a quick screen share if you prefer!
```
...
- Include clear CTA (demo link, question, etc.)
...
- Send on weekends (lower response rates)
