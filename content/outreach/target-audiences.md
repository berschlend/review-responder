# LinkedIn Target Audiences for ReviewResponder

> **Goal:** Identify and reach 100+ potential customers per week
> **Conversion Target:** 5-10% response rate, 1-2% conversion to paid

---

## TIER 1: HIGH-VALUE TARGETS (Highest conversion potential)
...
**Best Message Approach:** Direct value prop + time savings
...
**Best Message Approach:** Case study + professional tone emphasis
...
**Best Message Approach:** Multi-location efficiency angle
...
"Law Firm Owner" OR "Managing Partner" attorney
"Auto Shop Owner" OR "Service Manager" automotive
"Salon Owner" OR "Spa Owner"
"Gym Owner" OR "Fitness Studio"
"Real Estate Broker" OR "Realtor" reviews
```
...
**Best Message Approach:** Industry-specific pain points
...
**Best Message Approach:** Partnership/efficiency angle

---

## TIER 3: INDIRECT TARGETS (Influencers & Partners)
...
**Best Message Approach:** Partnership/affiliate opportunity
...
**Best Message Approach:** Product demo + story angle
...
3. Export to CSV (use scraper script)
4. Clean data (remove irrelevant profiles)
5. Target: 100 prospects per week
```
...
Wednesday: Follow-up accepted connections
Thursday:  25 connection requests
Friday:    25 connection requests + weekly review
```
...
- B2B only (no consumer reviews)
- Non-English primary market (unless German)
...
- **Healthcare:** Start of year (new insurance)
